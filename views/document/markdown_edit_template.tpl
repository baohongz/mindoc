...
<div class="m-manual manual-editor">
    <div class="manual-head" id="editormd-tools" style="min-width: 1200px; position:absolute;">
        ...
        <div class="editormd-group">
            ...
            <a href="javascript:;" data-toggle="tooltip" data-title="emoji" unselectable="on"><i class="fa fa-smile-o" name="emoji" unselectable="on"></i></a>
...
<script src="/static/ocpu/opencpu-0.5.js"></script>
<script src="/static/ocpu/opencpu-server.js"></script>
<script src='/static/jquery/jquery-resizable.js'></script>
...
<script>
    ...
    var plotPanel = jsPanel.create({
        panelSize: '160 0',
        position: 'left-bottom 50 -4',
        dragit: { containment: [-10, -500, -400, -500] }, // set dragging range of VIP window
        boxShadow: 1,
        ...
        headerTitle: function () {return '<strong>quickr.ai console</strong>'},
        contentAjax: {
            url: '/static/interface_edit.html',
            done: function (panel) {
        ...
        onwindowresize: function(event, panel) {
            ...
            if (jptop<-10 || window.innerHeight-jptop<10 || window.innerWidth-jpleft<10 || jpleft+parseInt(this.currentData.width)<10) {
                panel.reposition("center-top 0 180");
            }
        },
        ...
        onsmallified: function (panel, status) {
            this.reposition('left-bottom 50 -4');
